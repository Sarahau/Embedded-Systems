...
void gameSetUp()
{
    ...
    if (whackerButton.wasPressed()) {
        Serial.println("whacker was selected");
        ...
        Serial.println("popper was selected");
...
void drawIntroScreen(){
    // while(thisDeviceGameState == SETUP){
        ...
        M5.Lcd.fillRect(popperButton.x, popperButton.y, popperButton.w, popperButton.h, GREEN);
        M5.Lcd.println("Popper");

        M5.Lcd.setCursor(40, sHeight-55);
        whackerButton = Button(20, sHeight- 75, 120, 55, "Whacker");
        M5.Lcd.fillRect(whackerButton.x, whackerButton.y, whackerButton.w, whackerButton.h, RED);
...
void buttonAction(Event& e) {
    ...
    Serial.println(b.instanceIndex());
